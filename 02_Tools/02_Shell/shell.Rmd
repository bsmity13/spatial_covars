...
Neither do I. I have done a bit of dabbling, but I mostly use Window's default, `cmd.exe`, even though I have PowerShell and Git bash ready to go. `-1 nerd point` for me `r emo::ji("thumbs down")`
...
We can also call programs using their absolute path *without* changing directories.
