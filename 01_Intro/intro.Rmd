...
This workshop will, of course, focus on the data we need for our analyses. But it is also focused on building the skills to download the remote data, efficiently, from wherever it may be housed.

The primary focus will be on downloading data from R, and this workshop and all of its associated materials are written almost entirely in R (with R Markdown).
